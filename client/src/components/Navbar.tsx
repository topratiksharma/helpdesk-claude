    ...
    <header className="bg-surface border-b border-border sticky top-0 z-40">
      <div className="max-w-[1200px] mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-[6px] bg-forest flex items-center justify-center shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-7 h-7 rounded-full bg-forest flex items-center justify-center shrink-0">
            <span className="text-[11px] font-semibold text-white leading-none uppercase">
              {user.name.charAt(0)}
            </span>
          </div>

          <span className="text-[13.5px] text-ink-muted max-w-[180px] overflow-hidden text-ellipsis whitespace-nowrap">
            {user.name}
          </span>
